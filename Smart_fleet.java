...
public class Smart_fleet {
    ...
    static class Vehicle {
        ...
        Vehicle(String id, String number, String model, String type, String status) {
            this.id = id;
            this.number = number;
            this.model = model;
            this.type = type;
    ...
    static class Driver {
        ...
        Driver(String id, String name, String phone, String license, String vehicleNumber) {
            this.id = id;
            this.name = name;
            this.phone = phone;
    ...
    static class Trip {
        ...
        Trip(String id, String vehicleNumber, String driverName,
             String source, String destination, double distance, String status) {
            this.id = id;
            this.vehicleNumber = vehicleNumber;
    ...
    static class Maintenance {
        ...
        double cost;
        Maintenance(String id, String vehicleNumber, String serviceType,
                    String date, double cost, String remarks) {
            this.id = id;
            this.vehicleNumber = vehicleNumber;
    ...
    static void addVehicle() {
        ...
        vehicles.add(new Vehicle(id, number, model, type, status));
    ...
    static void addDriver() {
        ...
        drivers.add(new Driver(id, name, phone, license, vehicleNumber));
    ...
    static void addTrip() {
        ...
        String status = sc.nextLine();
        trips.add(new Trip(id, vehicle, driver, source,
    ...
    static void addFuel() {
        ...
        String type = sc.nextLine();
        double quantity = readDouble("Enter Quantity (Litres): ");
        double cost = readDouble("Enter Cost: ");
        System.out.print("Enter Date: ");
        String date = sc.nextLine();
        fuels.add(new Fuel(id, vehicle, type, quantity, cost, date));
    ...
    static void addMaintenance() {
        ...
        maintenanceList.add(new Maintenance(id, vehicle, service,
                date, cost, remarks));
    ...
    static void reports() {
        ...
        System.out.println("Fuel Records        : " + fuels.size());
        System.out.println("Maintenance Records : " + maintenanceList.size());
        System.out.println("========================================");
    }
